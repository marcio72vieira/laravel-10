...
class SupportController extends Controller
{
    ...
    {
        // $supports = Support::paginate(); // Método alternativo

        $supports = $this->service->paginate(page: $request->get('page', 1), totalPerPage: $request->get('per_page', 4), filter: $request->filter );
